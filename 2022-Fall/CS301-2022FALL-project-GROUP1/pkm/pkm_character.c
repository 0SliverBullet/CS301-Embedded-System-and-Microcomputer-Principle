...
int normal_attack_skill(struct character *p){
...
void grow_attack_skill(struct character *p){
...
void unique_skill(struct character *p){
	int atk_value = p->ATK;
...
void defend_clpt(struct character *p, int attack_value){
	if(p->is_active_defend == 1){
