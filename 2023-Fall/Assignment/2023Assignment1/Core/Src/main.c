...
int main(void)
{
  ...
  while (1)
  {
	...
	for (x1=186;x1<240;x1++){
				LCD_Fast_DrawPoint(x1, 160, BLUE);
		     	}
	  POINT_COLOR = BLUE;
	  LCD_ShowString(54, 148, 132, 24, 24, (uint8_t*) "Decode Mode");
	  LCD_ShowString(10, 30, 200, 16, 16, (uint8_t*) "Ciphertext:");
	  LCD_ShowString(10, 178, 200, 16, 16, (uint8_t*) "Plaintext:");
